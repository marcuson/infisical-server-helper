# ApiV1UserProjectAdditionalPrivilegePostRequestPermissionsInnerAnyOf1
...
```typescript
import { ApiV1UserProjectAdditionalPrivilegePostRequestPermissionsInnerAnyOf1 } from './api';

const instance: ApiV1UserProjectAdditionalPrivilegePostRequestPermissionsInnerAnyOf1 = {
    subject,
    inverted,
    action,
    conditions,
