# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf14
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf14 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf14 = {
    subject,
    action,
};
```
