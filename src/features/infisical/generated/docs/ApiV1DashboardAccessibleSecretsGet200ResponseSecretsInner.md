# ApiV1DashboardAccessibleSecretsGet200ResponseSecretsInner
...
```typescript
import { ApiV1DashboardAccessibleSecretsGet200ResponseSecretsInner } from './api';

const instance: ApiV1DashboardAccessibleSecretsGet200ResponseSecretsInner = {
    id,
    _id,
    workspace,
    environment,
