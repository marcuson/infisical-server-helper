# ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf5
...
```typescript
import { ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf5 } from './api';

const instance: ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf5 = {
    id,
    name,
    description,
    version,
