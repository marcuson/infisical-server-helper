# ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf4
...
```typescript
import { ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf4 } from './api';

const instance: ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf4 = {
    id,
    name,
    description,
    version,
