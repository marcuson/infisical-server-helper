# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf8
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf8 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf8 = {
    subject,
    action,
};
```
