# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf2
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf2 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf2 = {
    subject,
    action,
};
```
