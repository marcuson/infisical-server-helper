# ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf3
...
```typescript
import { ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf3 } from './api';

const instance: ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf3 = {
    id,
    name,
    description,
    version,
