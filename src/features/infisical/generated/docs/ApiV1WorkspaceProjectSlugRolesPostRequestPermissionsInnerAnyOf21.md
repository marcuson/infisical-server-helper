# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf21
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf21 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf21 = {
    subject,
    action,
};
```
