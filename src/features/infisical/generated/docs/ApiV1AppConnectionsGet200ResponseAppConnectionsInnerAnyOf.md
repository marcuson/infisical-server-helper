# ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf
...
```typescript
import { ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf } from './api';

const instance: ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf = {
    id,
    name,
    description,
    version,
