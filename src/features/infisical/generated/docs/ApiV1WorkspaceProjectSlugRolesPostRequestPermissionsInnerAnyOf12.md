# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf12
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf12 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf12 = {
    subject,
    action,
};
```
