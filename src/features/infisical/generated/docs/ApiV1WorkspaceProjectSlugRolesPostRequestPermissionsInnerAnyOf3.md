# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf3
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf3 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf3 = {
    subject,
    action,
};
```
