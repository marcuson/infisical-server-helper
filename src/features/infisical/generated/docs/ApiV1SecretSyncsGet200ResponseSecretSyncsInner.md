# ApiV1SecretSyncsGet200ResponseSecretSyncsInner
...
```typescript
import { ApiV1SecretSyncsGet200ResponseSecretSyncsInner } from './api';

const instance: ApiV1SecretSyncsGet200ResponseSecretSyncsInner = {
    id,
    name,
    description,
    isAutoSyncEnabled,
