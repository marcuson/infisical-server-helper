# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf9
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf9 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf9 = {
    subject,
    action,
};
```
