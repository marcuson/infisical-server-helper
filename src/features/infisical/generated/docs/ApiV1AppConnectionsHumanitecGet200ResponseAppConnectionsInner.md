# ApiV1AppConnectionsHumanitecGet200ResponseAppConnectionsInner
...
```typescript
import { ApiV1AppConnectionsHumanitecGet200ResponseAppConnectionsInner } from './api';

const instance: ApiV1AppConnectionsHumanitecGet200ResponseAppConnectionsInner = {
    id,
    name,
    description,
    version,
