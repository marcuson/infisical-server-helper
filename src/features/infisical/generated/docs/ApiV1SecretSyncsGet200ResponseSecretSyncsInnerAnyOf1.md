# ApiV1SecretSyncsGet200ResponseSecretSyncsInnerAnyOf1
...
```typescript
import { ApiV1SecretSyncsGet200ResponseSecretSyncsInnerAnyOf1 } from './api';

const instance: ApiV1SecretSyncsGet200ResponseSecretSyncsInnerAnyOf1 = {
    id,
    name,
    description,
    isAutoSyncEnabled,
