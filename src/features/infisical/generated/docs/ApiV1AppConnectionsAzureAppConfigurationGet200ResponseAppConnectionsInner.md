# ApiV1AppConnectionsAzureAppConfigurationGet200ResponseAppConnectionsInner
...
```typescript
import { ApiV1AppConnectionsAzureAppConfigurationGet200ResponseAppConnectionsInner } from './api';

const instance: ApiV1AppConnectionsAzureAppConfigurationGet200ResponseAppConnectionsInner = {
    id,
    name,
    description,
    version,
