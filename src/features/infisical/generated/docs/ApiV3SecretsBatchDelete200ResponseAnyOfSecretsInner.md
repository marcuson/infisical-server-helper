# ApiV3SecretsBatchDelete200ResponseAnyOfSecretsInner
...
```typescript
import { ApiV3SecretsBatchDelete200ResponseAnyOfSecretsInner } from './api';

const instance: ApiV3SecretsBatchDelete200ResponseAnyOfSecretsInner = {
    id,
    version,
    type,
    secretKeyCiphertext,
