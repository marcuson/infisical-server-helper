# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf23
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf23 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf23 = {
    subject,
    action,
};
```
