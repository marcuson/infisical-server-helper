# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf22
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf22 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf22 = {
    subject,
    action,
};
```
