...
```typescript
import { ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner } from './api';

const instance: ApiV1SecretSecretIdSecretVersionsGet200ResponseSecretVersionsInner = {
    id,
    _id,
    workspace,
    environment,
