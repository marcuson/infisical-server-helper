# ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf6
...
```typescript
import { ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf6 } from './api';

const instance: ApiV1AppConnectionsGet200ResponseAppConnectionsInnerAnyOf6 = {
    id,
    name,
    description,
    version,
