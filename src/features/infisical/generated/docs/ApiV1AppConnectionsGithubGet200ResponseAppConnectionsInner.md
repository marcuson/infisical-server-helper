# ApiV1AppConnectionsGithubGet200ResponseAppConnectionsInner
...
```typescript
import { ApiV1AppConnectionsGithubGet200ResponseAppConnectionsInner } from './api';

const instance: ApiV1AppConnectionsGithubGet200ResponseAppConnectionsInner = {
    id,
    name,
    description,
    version,
