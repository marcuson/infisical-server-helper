# ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf24
...
```typescript
import { ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf24 } from './api';

const instance: ApiV1WorkspaceProjectSlugRolesPostRequestPermissionsInnerAnyOf24 = {
    subject,
    action,
};
```
